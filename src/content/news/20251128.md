...
Nisin may be an example of such a molecule. It's a widely known natural product, synthesized by bacteria, from the class of ribosomally synthesized and post-translationally modified peptides. We show that sponge bacteria (especially <i class='taxon'>Acidobacteriota</i>) have a lot more of those molecules, judged by genomic data. Such small peptide clusters are of particular interest for further heterologous expression.
